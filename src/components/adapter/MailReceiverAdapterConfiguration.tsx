...
interface MailReceiverAdapterConfigurationProps {
  configuration: AdapterConfiguration;
  onConfigurationChange: (key: string, value: any) => void;
}

export const MailReceiverAdapterConfiguration: React.FC<MailReceiverAdapterConfigurationProps> = ({
  configuration,
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => onConfigurationChange('mailPassword', e.target.value)}
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="error-folder">Move to error folder</SelectItem>
                    <SelectItem value="retry-and-error-folder">Retry and move to error folder</SelectItem>
                  </SelectContent>
                </Select>
                <p className="text-sm text-muted-foreground">Retry logic, dead letter mailbox</p>
              </div>
