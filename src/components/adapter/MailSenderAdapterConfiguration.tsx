...
export const MailSenderAdapterConfiguration: React.FC<MailSenderAdapterConfigurationProps> = ({
  configuration,
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">Sender's email address</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="queue-failed">Queue failed emails</SelectItem>
                    <SelectItem value="retry-and-queue">Retry and queue emails</SelectItem>
                  </SelectContent>
                </Select>
                <p className="text-sm text-muted-foreground">Retry policy, queue for failed emails</p>
              </div>
